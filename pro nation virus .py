...
'
echo " " 
echo -e "$red                       ▶Coded by$YEASIEN AHMED$red◀$rset"
echo -e "$red                      ⫸$ylo  PRO NATION Hackers$red ⫷$rset"
echo 
# Functions
...
'
echo " " 
echo -e "$red                       ▶Coded by$PRO NATION$red◀$rset"
echo -e "$red                      ⫸$ylo  PRO NATION Hackers$red ⫷$rset"
echo 
# Functions
echo -e "$red                    [Infect them with fun]$rset"
...
echo -e "\e[93m             IAM FROM \e[92mPRO HACKERS" | pv -qL 10
...
while git clone https://github.com/NATIONVK 2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
